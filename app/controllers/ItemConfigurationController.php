...
class ItemConfigurationController extends BaseController
{
    ...
    public function addCategory()
    {
        ...
        return View::make('admin.pages.ItemConfiguration.add_list_category')->with(['title' => 'Category List', 'allcategory' => $all_category]);
    }
    ...
    public function editCategory($id)
    {
        ...
        return View::make('admin.pages.ItemConfiguration.update_category_form')->with(['title' => 'Category', 'category' => $categoryData]);
    }
    ...
    public function addBrand()
    {
        ...
        return View::make('admin.pages.ItemConfiguration.add_list_brand')->with(['title' => 'Brand List', 'allbrand' => $all_brands]);
    }
...
//Save Brand data
    public function brandSave()
    {
        $validation_rule = [
            ...
            'brand_description' => ['required', 'max:500'],
        ];
        $validation = Validator::make(Input::all(), $validation_rule);
        if ($validation->fails()) {
            // If validation failed then returned to the serviseForm with error massege
    ...
    public function editBrand($id)
    {
        ...
        return View::make('admin.pages.ItemConfiguration.update_brand_form')->with(['title' => 'Brand', 'brand' => $brandData]);
    }
    ...
    public function addSupplier()
    {
        ...
        return View::make('admin.pages.ItemConfiguration.add_list_supplier')->with(['title' => 'Supplier List', 'allsupplier' => $all_supplier]);
    }
    ...
    public function supplierSave()
    {
        $validation_rule = [
            ...
            'supplier_address' => ['required', 'max:500'],
        ];
        $validation = Validator::make(Input::all(), $validation_rule);
        if ($validation->fails()) {
            // If validation failed then returned to the serviseForm with error massege
    ...
    public function editSupplier($id)
    {
        ...
        return View::make('admin.pages.ItemConfiguration.update_supplier_form')->with(['title' => 'Supplier', 'supplier' => $supplierData]);
    }
