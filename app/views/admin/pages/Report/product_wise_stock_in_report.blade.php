...
<section class="content">
          <div class="row">
            <div class="col-xs-12">
<?php if (isset($searched_product))  var_dump($searched_product) ?>
              <div class="box">
                <div class="box-header">
                    <div class="row">
                        <div class="col-md-6"><h3 class="box-title">Data Table With Full Features</h3></div>
                         <?php echo Form::open(array('route' => 'productWiseStockInReportSearch', 'class' => 'form-horizontal')) ?>
                        <div class="col-md-4"> 
                            <?php
...
<!--                            <label>Select Product</label>
                        ...
                        <div class="col-md-2"> <?php echo Form::submit('Submit', array('class' => 'btn btn-info pull-left inside_body_submit')) ?></div>
                     <?php echo Form::close(); ?>
                    </div>
