...
class StockOut extends \Eloquent
{
    ...
    public static function addProductStockOut($product_id, $product_count, $requisition_number, $requisition_by, $recipient, $token, $c_date)
    {
    ...
    public static function getAllProductsStockIn()
    {
...
//End of the getAlProducts
    ...
    public static function getAllProductsStackOutExl()
    {
    ...
    public static function getAllProductsStackOut()
    {
    ...
    public static function getProductFromStockOutById($id)
    {
    ...
    public static function updateProductStockOut($product_id, $product_count, $requisition_number, $requisition_by, $recipient, $token, $c_date, $stock_out_id)
    {
        DB::table('stock_out')
