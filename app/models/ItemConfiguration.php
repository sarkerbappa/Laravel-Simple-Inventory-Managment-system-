...
//End of the getAll$category
      ...
      //Update Category by id
        public static function UpdateCategory($category_id, $category_name, $category_description)
        {
            DB::table('category')
  ...
  /*============================================== Brand ======================================*/
        ...
        //Add new Brand
        public static function addBrand($brand_name, $brand_description)
        {
...
//End of the getAll$category
      ...
      //Update Brand by id
        public static function UpdateBrand($brand_id, $brand_name, $brand_description)
        {
            DB::table('brand')
    ...
    /*============================================== Supplier ======================================*/
         //Add new Spplier
        public static function addSupplier($supplier_name, $supplier_address)
        {
...
//End of the getAll$category
      ...
      //Update Supplier by id
        ...
        public static function deleteSupplierId($id)
        {
       ...
       /*============================================== Product ======================================*/
        ...
        //Add new Spplier
        public static function addProduct($product_name, $product_description, $cat_id, $brand_id)
        {
...
//End of the getAlProducts
    ...
    public static function editProductSave($product_id, $product_name, $product_description, $cat_id, $brand_id)
    {
        DB::table('products')
