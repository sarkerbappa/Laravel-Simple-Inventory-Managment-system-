...
class StockIn extends \Eloquent
{
    ...
    public static function addProductInStock($product_id, $product_count, $order_number, $supplier_id, $order_date, $token)
    {
    ...
    public static function getAllProductsInStack()
    {
    ...
    public static function getProductFromStockById($id)
    {
    ...
    public static function getProductNumberfromStockinByProductId($product_id)
    {
    ...
    public static function updateProductInStock($stock_id, $product_id, $product_count, $order_number, $supplier_id, $order_date, $token)
    {
        DB::table('stock_in')
