...
class Report extends \Eloquent {
	protected $fillable = [];
        ...
        static function RestProductInStock() {
       ...
       static function generalStockReport(){
       ...
       static function searchProductInStock($product_id){
           $search_stock_in = DB::table('products')->where('Product_Id', '=', $product_id)->get();
           return $search_stock_in;
       }

              static function productWiseStockInReport(){
